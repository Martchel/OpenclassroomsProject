...
function afficherProposition(proposition) {
    let motAffiché = document.querySelector(".zoneProposition")
    motAffiché.innerText = proposition
}
...
function lancerJeu() {
    ...
    let motEntrée = document.getElementById("inputEcriture")
    afficherProposition(listeMots[i])
    monBouton.addEventListener("click", () => {
        console.log(motEntrée.value)
        if(motEntrée.value === listeMots[i]){
            score++                
        }
        i++
